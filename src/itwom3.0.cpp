...
double adiff(double d, prop_type &prop, propa_type &propa)
{
	...
	thread_local static double wd1, xd1, afo, qk, aht, xht;
...
{
	complex<double> prop_zgnd(prop.zgndreal,prop.zgndimag);
	thread_local static double wd1, xd1, qk, aht, xht, toh, toho, roh, roho, dto, dto1, dtro, dro, 
...
{
	thread_local static double ad, rr, etq, h0s;
...
{
	complex<double> prop_zgnd(prop.zgndreal,prop.zgndimag);
	thread_local static double wls;
	complex<double> r;
	double s, sps, q;
	double alosv;
...
void lrprop (double d, prop_type &prop, propa_type &propa)
{
	...
	thread_local static bool wlos, wscat;
	thread_local static double dmin, xae;
	complex<double> prop_zgnd(prop.zgndreal,prop.zgndimag);
...
{
	thread_local static	int kdv;
	thread_local static	double dexa, de, vmd, vs0, sgl, sgtm, sgtp, sgtd, tgtd,
	...
	thread_local static bool ws, w1;
